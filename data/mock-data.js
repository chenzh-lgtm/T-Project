...
const mentalHealthArticles = [
  {
    ...
    category: '学习压力',
    readCount: 1256,
    content: `考试前感到紧张是很正常的现象。适度的焦虑可以帮助我们保持警觉，提高学习效率，但过度的焦虑则会影响我们的发挥。以下是一些应对考试焦虑的实用方法：

一、认知调整
• 理性看待考试：考试只是检验学习成果的一种方式，不是人生的全部
• 积极的自我暗示：告诉自己"我已经准备得很充分了"
• 避免灾难性思维：不要总是想"如果考砸了怎么办"

二、行为调节
• 规律作息：保持充足的睡眠，每天至少7-8小时
• 适度运动：每天进行30分钟的运动，如散步、慢跑等
• 呼吸练习：478呼吸法——吸气4秒，屏息7秒，呼气8秒

三、学习方法
• 制定合理的复习计划：将大目标分解成小任务
• 主动回忆：尝试不看答案回忆知识点
• 模拟考试：按照考试时间安排进行模拟练习
...
记住，焦虑是可以管理的。当你感到紧张时，不妨停下来，深呼吸，相信自己的能力。`
  },
  {
    id: 2,
    title: '建立良好的人际关系',
    ...
    category: '人际交往',
    readCount: 980,
    content: `良好的人际关系是心理健康的重要支柱。与他人建立积极、健康的联系可以给我们带来归属感、支持和快乐。以下是建立良好人际关系的一些建议：

一、倾听是关键
• 全神贯注：放下手机，给对方充分的关注
• 不打断：让对方把话说完再表达自己的观点
• 共情回应：用"我理解你的感受"这样的语言回应

二、有效沟通
• 表达清晰：直接、诚实地表达你的想法和感受
• 使用"我"语句：用"我感到..."代替"你总是..."
• 适时赞美：真诚地赞美对方的优点和努力

三、建立边界
• 学会说"不"：尊重自己的时间和精力
• 明确期望：清楚表达你的期望和需求
• 尊重差异：接受他人与你不同的观点和生活方式
...
人际关系需要用心经营。记住，真诚和尊重是所有良好关系的基础。`
  },
  {
    ...
    category: '情绪调节',
    readCount: 1560,
    content: `情绪是我们生活的一部分，没有好坏之分。但学会有效地管理情绪可以帮助我们更好地应对生活中的挑战。以下是一些实用的情绪管理技巧：

一、情绪觉察
• 命名情绪：准确识别自己的感受——是愤怒、悲伤还是焦虑？
• 身体扫描：注意情绪在身体上的反应，如心跳加速、肌肉紧张
• 情绪日记：记录每天的情绪变化和触发因素

二、情绪接纳
• 不评判：允许自己有负面情绪，不要自责
• 正常化：告诉自己"有这种感觉是正常的"
• 观察而非认同：把情绪看作是暂时的访客，不是你的全部

三、情绪调节
• 暂停技术：感到情绪激动时，先数到10再行动
• 离开现场：如果环境让你难受，暂时离开
• 身体活动：运动、散步、跳舞都能改善心情
...
• 培养爱好：做一些让你感到快乐的事情
• 社会支持：与亲友分享你的感受
• 专业帮助：如果情绪问题持续影响生活，寻求心理咨询

记住，情绪管理不是压抑情绪，而是学会与情绪和谐共处。`
  },
  {
    id: 4,
    title: '大学生职业规划指南',
    ...
    category: '职业规划',
    readCount: 890,
    content: `职业规划是一个持续的过程，不是一蹴而就的决定。大学期间是探索和规划职业生涯的黄金时期。以下是一些职业规划的建议：

一、自我探索
• 兴趣探索：你喜欢做什么？做什么事情让你感到充实？
• 能力评估：你擅长什么？有哪些技能？
• 价值观澄清：工作中什么对你最重要？收入、成长还是稳定？

二、职业探索
• 职业访谈：与不同行业的人交流，了解真实的工作状态
• 实习实践：通过实习亲身体验不同的工作
• 信息收集：利用网络、书籍了解各行业发展趋势
...
记住，最好的职业规划是让你成为更好的自己。选择一份让你感到有意义、有成长的工作，比单纯追求高薪更重要。`
  },
  {
    id: 5,
    title: '失眠的自我调节方法',
    summary: '良好的睡眠是身心健康的基础，教你如何改善睡眠质量...',
    category: '身心健康',
    readCount: 789,
    content: `睡眠是身体和大脑恢复的重要过程。长期失眠会影响注意力、情绪和身体健康。以下是一些改善睡眠的方法：

一、睡眠习惯
• 规律作息：每天在相同时间上床和起床，包括周末
• 睡前准备：睡前1小时停止使用电子设备
• 创造环境：保持卧室黑暗、安静、凉爽（18-22°C）

二、睡前放松
• 温水泡脚：15-20分钟，水温40°C左右
• 阅读书籍：选择轻松的读物，避免刺激内容
• 冥想练习：5-10分钟的正念冥想帮助平静身心

三、饮食注意
• 避免咖啡因：下午2点后不喝咖啡、茶、可乐
• 适量进食：睡前不要过饿或过饱
• 限制液体：睡前1小时减少饮水量
...
记住，偶尔失眠是正常的。关键是建立健康的睡眠习惯，而不是过度焦虑。`
  },
  {
    id: 6,
    title: '如何面对挫折与失败',
    summary: '挫折是人生的必修课，学会如何从失败中学习和成长...',
    category: '心理成长',
    readCount: 1123,
    content: `人生不会一帆风顺，挫折和失败是成长的必经之路。如何面对挫折，决定了我们能走多远。以下是一些应对挫折的建议：
...
二、理性分析
• 区分事实和想法：失败是事实，但"我是个失败者"只是想法
• 寻找原因：分析失败的具体原因，不是笼统否定自己
• 可控与不可控：哪些是你可以改变的，哪些需要接受

三、重新定义
• 成长型思维：把失败看作学习的机会
• 重新解读："这次没成功"不代表"我永远不行"
• 寻找意义：这次经历教会了你什么？

四、调整期望
• 合理目标：设定可实现的目标，避免完美主义
• 分解任务：将大目标分解成小步骤
• 庆祝小成：每一个小进步都值得肯定
...
记住，每一次挫折都是一次成长的机会。真正重要的不是你从未跌倒，而是每次跌倒后都能重新站起来。`
  }
];
